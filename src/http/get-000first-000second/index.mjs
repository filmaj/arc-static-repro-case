...
<body class="padding-32">
  <div class="max-width-320">
    <img src="${arc.static('steve-likes-beers.gif')}" />
    <div class="margin-left-8">
      <div class="margin-bottom-16">
        <h1 class="margin-bottom-16">
          Hello from Architect GET /:first/:second handler! The path args are: "${req.params.first}" and "${req.params.second}"
        </h1>
        <p class="margin-bottom-8">
          Get started by editing this file at:
        </p>
        <code>
          src/http/get-000first-000second/index.mjs
        </code>
      </div>
      <div>
        <p class="margin-bottom-8">
